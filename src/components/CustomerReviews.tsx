      ...
      <div className="container px-4 mx-auto">
        ...
        {showForm && !submitted && (
          ...
          >
            ...
            {/* Photo upload */}
            <div>
              <label className="text-sm font-medium text-foreground mb-1 block">Votre photo (optionnel)</label>
              <input ref={fileInputRef} type="file" accept="image/*" onChange={handleFileChange} className="hidden" />
              <div className="flex items-center gap-3">
                <div
                  className="w-12 h-12 rounded-full border-2 border-dashed border-border hover:border-primary transition-colors cursor-pointer overflow-hidden flex items-center justify-center bg-muted"
