    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 pt-20 text-center text-white">
        <motion.div
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-serif font-bold mb-6 leading-[1.15] drop-shadow-lg max-w-4xl mx-auto">
            Le magazine N°1 de la pêche au coup depuis 20 ans
          </h1>
